...
If your host forces a different port (example `3001`), set:

```bash
export CHAT_MA_SERVER=http://localhost:3001
```

The CLI also auto-retries `localhost:3001` if `localhost:3000` is unreachable.
