    ...
    try {
      ...
      const pageIssues = issues.map((issue) => {
        ...
        return {
          ...
          notes: issue.notes || '',
          issueMarkedAtMillis: Number.isFinite(issue.issueMarkedAtMillis) ? issue.issueMarkedAtMillis : null,
          responseDueAtMillis: Number.isFinite(issue.responseDueAtMillis) ? issue.responseDueAtMillis : null,
          responseExpired: Number.isFinite(issue.responseDueAtMillis) ? issue.responseDueAtMillis <= Date.now() : false,
